// Создание кода T4 для модели "C:\Users\ivan\source\repos\Выбор перевозчика методом предпочтений на примере порта\DatabaseEntities\EntityModel.edmx" включено. 
